...
function  get_all_contact()
{
    ...
    $filter = "(&(|(objectCategory=person)(objectClass=contact))(|(telephonenumber=*)(othertelephone=*)(mobile=*)))";
    $attr = array("cn", "mail", "title", "department", "company", "description", "telephonenumber", "othertelephone","title","streetaddress","mobile");

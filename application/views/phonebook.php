	...
	<tbody>
            <?php for ($i = 0; $i < $result_entries['count']; $i++) { ?>
             ...
             <tr class=odd gradeC>
                 ...
                 <td><?php if(isset($result_entries[$i]['mail'][0])) { echo  $result_entries[$i]['mail'][0]; }?></td> 
                 <td><b><?php if(isset($result_entries[$i]['telephonenumber'][0])) { echo  $result_entries[$i]['telephonenumber'][0]; }?></b></td> 
                 <td><?php if(isset($result_entries[$i]['othertelephone'][0])) { echo  $result_entries[$i]['othertelephone'][0]; }?></td>
                 <td><?php if(isset($result_entries[$i]['mobile'][0])) { echo  $result_entries[$i]['mobile'][0]; }?></td>
                 <td><?php if(isset($result_entries[$i]['streetaddress'][0])) { echo  $result_entries[$i]['streetaddress'][0]; }?></td>
             </tr>
            <?php } ?>
	</tbody>
